...
public class PlayerController3D : Singleton<PlayerController3D>
{
    ...
    void Update()
    {
        ...
        if (InputHandler.Instance.Jump.Up && rb.linearVelocity.y > 0)
        {
            rb.linearVelocity = new Vector3(rb.linearVelocity.x, rb.linearVelocity.y * spaceReleaseGravMult, rb.linearVelocity.z);
        }
    }
    ...
    void FixedUpdate()
    {
        ...
        if (InputHandler.Instance.Jump.Holding && rb.linearVelocity.y > 0)
            rb.linearVelocity -= new Vector3(0, gravUp, 0);
        else
            rb.linearVelocity -= new Vector3(0, gravDown, 0);
        #endregion
        ...
        if (grounded)
        {
            ...
            rb.linearVelocity = new Vector3(0, rb.linearVelocity.y, 0) + transform.TransformDirection(updatedVelocity);
        }
        else
        {
            //Apply air fricion
